...
time.sleep(3)
country ="Chad"
driver.find_element_by_android_uiautomator('new UiScrollable(new UiSelector()).scrollIntoView(new UiSelector().textContains("'+country+'"))').click()
time.sleep(3)
...
termAndCoditions = driver.find_element_by_xpath("//*[@text='Please read our terms of conditions']")

tc = TouchAction(driver)
tc.long_press(termAndCoditions).perform()
